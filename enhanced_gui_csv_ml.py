...
class MassiveDatasetBoltDetectionGUI:
    ...
    def __init__(self, root):
        ...
        self.log_message("📊 New Features: CSV Upload, ML Trinity (RF+XGBoost+Ensemble)")
    ...
    def create_setup_tab(self):
        ...
        subtitle_label = tk.Label(setup_frame, text="ML Trinity: Random Forest + XGBoost + Ensemble | CSV Upload",
